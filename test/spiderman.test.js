...
describe("Unit Tests for Spiderman class", () => {
  ...
  describe("Unit Tests for Spiderman  method getInfo", () => {
    test('2) Use the method getInfo()', () => {
        const tomHollan = new Spiderman("Spiderman Marvel",25, "Tom Holland", 5,"Marvel")
        expect(tomHollan.getInfo()).toBe("Hey, I'm Tom Holland from Marvel studio")
    })
  });